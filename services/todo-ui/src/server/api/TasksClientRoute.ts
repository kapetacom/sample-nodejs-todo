...
export class TasksClientRoute extends RestRoute {
    ...
    _initRoutes() {
        ...
        if (!client.getTasks) {
            throw new Error('REST resource client for "Tasks" is missing method: "getTasks"');
        }
        ...
        if (!client.addTask) {
            throw new Error('REST resource client for "Tasks" is missing method: "addTask"');
        }

        //addTask: Verify the method is implemented correctly
        this.validateMethod(client.addTask, 'addTask', ['userId', 'id', 'task']);
        ...
        if (!client.markAsDone) {
            throw new Error('REST resource client for "Tasks" is missing method: "markAsDone"');
        }
        ...
        if (!client.removeTask) {
            throw new Error('REST resource client for "Tasks" is missing method: "removeTask"');
        }
        ...
        if (!client.removeTasks) {
            throw new Error('REST resource client for "Tasks" is missing method: "removeTasks"');
        }
